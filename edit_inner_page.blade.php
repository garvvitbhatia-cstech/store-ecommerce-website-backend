                        ...
                        <div class="card">
                           ...
                           <div class="body">
                              ...
                              <div class="form-group form-float">
                                 ...
                                 <div class="form-line">
                                    <textarea id="description" name="description" onkeyup="checkError(this.id);" rows="5" confirmation="false" class="editorBox form-control">{{ $innerpage->description }}</textarea>                                    
                                 </div>
                                 @error('description')

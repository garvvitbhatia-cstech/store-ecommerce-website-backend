                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        {{ Form::open(array('url' => '/admins/add-city/','id' => 'pageForm', 'method' => 'post', 'files' => true)) }}
                                            @csrf                                                      
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" name="heading" id="heading" class="form-control">                                                </div>
                                                @error('heading')
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                	<textarea name="description" id="description" rows="6" class="form-control"></textarea>                                                </div>
                                                @error('description')
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" name="seo_title" id="seo_title" class="form-control">                                                </div>
                                                @error('seo_title')
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                	<textarea name="seo_description" id="seo_description" rows="6" class="form-control"></textarea>                                                </div>
                                             ...
                                             <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                	<textarea name="seo_keywords" id="seo_keywords" rows="6" class="form-control"></textarea>                                                </div>
                                                @error('seo_keywords')

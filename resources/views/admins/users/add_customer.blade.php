                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        {{ Form::open(array('url' => '/admins/add-user/','id' => 'pageForm', 'method' => 'post', 'files' => true)) }}
                                            @csrf                                                      
                                            <div class="form-group form-float">
                                            	<label class="form-label">Full Name</label>
                                                <div class="form-line">
                                                    <input type="text" name="full_name" id="full_name" class="form-control">                                                </div>
                                                @error('full_name')
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" name="contact" maxlength="10" id="contact" class="form-control">
                                                </div>
                                                @error('contact')
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                	<textarea name="address" id="address" class="form-control"></textarea>                                                </div>
                                                @error('address')
